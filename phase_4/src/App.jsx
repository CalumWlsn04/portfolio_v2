...
function HomePage() {
  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section className="about section" id="about"><motion.div {...reveal}><SectionHeading label="About me" title="Curious by default, practical by nature." text="The projects show what I have built. This is a little more about the person behind them." /></motion.div><div className="about-grid"><motion.div className="about-copy" {...reveal}><p className="large-copy">I’m Calum—a software engineer who likes learning how things work, especially when a problem leads somewhere I have not worked before.</p><p>I tend to learn by building. That has taken me from machine learning and data pipelines to backend services, cloud infrastructure, operating systems, and full-stack products. I enjoy the point where an unfamiliar problem begins to make sense and turns into something useful.</p><p>I’m thoughtful, persistent, and comfortable asking questions when I do not know something. I care about doing work properly, communicating clearly, and leaving systems easier for the next person to understand.</p><p>At this stage of my career, I’m less interested in narrowing myself to one label than in joining a strong team, taking ownership, and continuing to grow across different areas of software engineering.</p></motion.div><div className="principles about-traits"><div><span>01</span><h3>How I learn</h3><p>I like to understand the underlying system rather than stop once something appears to work.</p></div><div><span>02</span><h3>How I work</h3><p>I break ambiguous problems into concrete steps, communicate progress, and iterate from evidence.</p></div><div><span>03</span><h3>What I value</h3><p>Curiosity, reliability, humility, and teammates who care about both the result and how it gets built.</p></div></div></div></section>
